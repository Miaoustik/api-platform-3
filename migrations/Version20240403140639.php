 ...
 */
final class Version20240403140639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT NOT NULL, dragon_treasure_id INT NOT NULL, message VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
